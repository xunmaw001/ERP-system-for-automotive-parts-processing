...
public class JingliController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JingliEntity user = jingliService.selectOne(new EntityWrapper<JingliEntity>().eq("jinglizhanghao", username));
    ...
    public R register(@RequestBody JingliEntity jingli){
    	...
    	JingliEntity user = jingliService.selectOne(new EntityWrapper<JingliEntity>().eq("jinglizhanghao", jingli.getJinglizhanghao()));
		if(user!=null) {
