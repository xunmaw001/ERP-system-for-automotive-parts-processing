<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">关于汽车零部件加工的erp系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jingli'" class="input-group">
			   <div class="label">经理账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jinglizhanghao" class="input" type="text" placeholder="经理账号">
			   </div>
			 </div> -->
			<el-form-item label="经理账号" class="input" v-if="tableName=='jingli'">
			  <el-input v-model="ruleForm.jinglizhanghao" autocomplete="off" placeholder="经理账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingli'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='jingli'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='jingli'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='jingli'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.jinglizhanghao) && `jingli` == this.tableName){
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `jingli` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if(`jingli` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
