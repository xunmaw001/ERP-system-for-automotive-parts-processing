  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wuliaobianhao" label="物料编号" prop="wuliaobianhao">
              <el-input v-model="ruleForm.wuliaobianhao" 
                placeholder="物料编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="供应商" prop="gongyingshang">
          <el-select :disabled="ro.gongyingshang" @change="gongyingshangChange" v-model="ruleForm.gongyingshang" placeholder="请选择供应商">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.gongyingshang" label="供应商" prop="gongyingshang">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="材料详情" prop="cailiaoxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.cailiaoxiangqing" label="材料详情" prop="cailiaoxiangqing">
                    <span v-html="ruleForm.cailiaoxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    gongyingshangChange () {
      this.$http({
        url: `follow/gongyingshang/gongyingshangmingcheng?columnValue=`+ this.ruleForm.gongyingshang,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.cailiaoxiangqing = this.ruleForm.cailiaoxiangqing.replace(reg,'../../../ssm94741/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `lingjiancailiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.lingjiancailiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
