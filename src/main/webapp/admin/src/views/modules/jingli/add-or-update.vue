      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="经理账号" prop="jinglizhanghao">
          <el-input v-model="ruleForm.jinglizhanghao" 
              placeholder="经理账号" clearable  :readonly="ro.jinglizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="经理账号" prop="jinglizhanghao">
              <el-input v-model="ruleForm.jinglizhanghao" 
                placeholder="经理账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
