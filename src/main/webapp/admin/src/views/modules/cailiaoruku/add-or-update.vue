<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物料编号" prop="wuliaobianhao">
          <el-input v-model="ruleForm.wuliaobianhao" 
              placeholder="物料编号" clearable  :readonly="ro.wuliaobianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物料编号" prop="wuliaobianhao">
              <el-input v-model="ruleForm.wuliaobianhao" 
                placeholder="物料编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物料名称" prop="wuliaomingcheng">
          <el-input v-model="ruleForm.wuliaomingcheng" 
              placeholder="物料名称" clearable  :readonly="ro.wuliaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物料名称" prop="wuliaomingcheng">
              <el-input v-model="ruleForm.wuliaomingcheng" 
                placeholder="物料名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.wuliaotupian" label="物料图片" prop="wuliaotupian">
          <file-upload
          tip="点击上传物料图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.wuliaotupian?ruleForm.wuliaotupian:''"
          @change="wuliaotupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.wuliaotupian" label="物料图片" prop="wuliaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.wuliaotupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物料类型" prop="wuliaoleixing">
          <el-input v-model="ruleForm.wuliaoleixing" 
              placeholder="物料类型" clearable  :readonly="ro.wuliaoleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物料类型" prop="wuliaoleixing">
              <el-input v-model="ruleForm.wuliaoleixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物料单价" prop="wuliaodanjia">
          <el-input v-model="ruleForm.wuliaodanjia" 
              placeholder="物料单价" clearable  :readonly="ro.wuliaodanjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物料单价" prop="wuliaodanjia">
              <el-input v-model="ruleForm.wuliaodanjia" 
                placeholder="物料单价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="库存位置" prop="kucunweizhi">
          <el-input v-model="ruleForm.kucunweizhi" 
              placeholder="库存位置" clearable  :readonly="ro.kucunweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="库存位置" prop="kucunweizhi">
              <el-input v-model="ruleForm.kucunweizhi" 
                placeholder="库存位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入库说明" prop="rukushuoming">
          <el-input v-model="ruleForm.rukushuoming" 
              placeholder="入库说明" clearable  :readonly="ro.rukushuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入库说明" prop="rukushuoming">
              <el-input v-model="ruleForm.rukushuoming" 
                placeholder="入库说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wuliaomingcheng = true;
          ...
          if(o=='wuliaotupian'){
            this.ruleForm.wuliaotupian = obj[o];
	    this.ro.wuliaotupian = true;
            continue;
          }
          if(o=='wuliaoleixing'){
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='wuliaodanjia'){
            this.ruleForm.wuliaodanjia = obj[o];
	    this.ro.wuliaodanjia = true;
            continue;
          }
          if(o=='kucunweizhi'){
            this.ruleForm.kucunweizhi = obj[o];
	    this.ro.kucunweizhi = true;
            continue;
          }
          if(o=='rukushijian'){
	...
	if(this.ruleForm.wuliaotupian!=null) {
		this.ruleForm.wuliaotupian = this.ruleForm.wuliaotupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `cailiaoruku/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cailiaorukuCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    wuliaotupianUploadChange(fileUrls) {
	this.ruleForm.wuliaotupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
