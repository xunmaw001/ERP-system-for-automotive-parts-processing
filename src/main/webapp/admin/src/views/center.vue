  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jingli'"  label="经理账号" prop="jinglizhanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jingli'"  label="年龄" prop="nianling">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jingli'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='jingli'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.zhaopian?ruleForm.zhaopian:''"
          @change="jinglizhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    jinglizhaopianUploadChange(fileUrls) {
        this.ruleForm.zhaopian = fileUrls;
    },
    onUpdateHandler() {
      ...
      if((!this.ruleForm.jinglizhanghao)&& 'jingli'==this.flag){
      ...
      if( 'jingli' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
